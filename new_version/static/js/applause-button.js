!function (e, t) {
    ...
    !function (t, n) {
        var r = t.document, o = t.Object, l = function (e) {
            var t, n, r, l, i = /^[A-Z]+[a-z]/, a = function (e, t) {
                (t = t.toLowerCase()) in u || (u[e] = (u[e] || []).concat(t), u[t] = u[t.toUpperCase()] = e)
            }, u = (o.create || o)(null), c = {};
            for (n in e) for (l in e[n]) for (r = e[n][l], u[l] = r, t = 0; t < r.length; t++) u[r[t].toLowerCase()] = u[r[t].toUpperCase()] = l;
        ...
        var i, a, u, c, s, m, f, p, d, h = "registerElement", L = "__" + h + (1e5 * t.Math.random() >> 0),
            C = "addEventListener", v = "attached", M = "Callback", T = "detached", E = "extends",
            b = "attributeChanged" + M, g = v + M, y = "connected" + M, H = "disconnected" + M, w = "created" + M,
            A = T + M, O = "ADDITION", _ = "REMOVAL", N = "DOMAttrModified", S = "DOMContentLoaded",
            D = "DOMSubtreeModified", k = "<", I = "=", P = /^[A-Z][A-Z0-9]*(?:-[A-Z0-9]+)+$/,
            F = ["ANNOTATION-XML", "COLOR-PROFILE", "FONT-FACE", "FONT-FACE-SRC", "FONT-FACE-URI", "FONT-FACE-FORMAT", "FONT-FACE-NAME", "MISSING-GLYPH"],
            R = [], x = [], V = "", z = r.documentElement, U = R.indexOf || function (e) {
                for (var t = this.length; t-- && this[t] !== e;) ;
                return t
            }, j = o.prototype, q = j.hasOwnProperty, B = j.isPrototypeOf, Z = o.defineProperty, G = [],
            K = o.getOwnPropertyDescriptor, W = o.getOwnPropertyNames, X = o.getPrototypeOf, J = o.setPrototypeOf,
            Q = !!o.__proto__, Y = "__dreCEv1", $ = t.customElements,
            ee = !/^force/.test(n.type) && !!($ && $.define && $.get && $.whenDefined), te = o.create || o,
            ne = t.Map || function () {
                var e, t = [], n = [];
                return {
                    get: function (e) {
                ...
                return e(o), r
            }, oe = !1, le = te(null), ie = te(null), ae = new ne, ue = function (e) {
                ...
                return e
            }), me = t.MutationObserver || t.WebKitMutationObserver, fe = (t.HTMLElement || t.Element || t.Node).prototype,
            pe = !B.call(fe, z), de = pe ? function (e, t, n) {
                return e[t] = n.value, e
            } : Z, he = pe ? function (e) {
                return 1 === e.nodeType
            } : function (e) {
                return B.call(fe, e)
            }, Le = pe && [], Ce = fe.attachShadow, ve = fe.cloneNode, Me = fe.dispatchEvent, Te = fe.getAttribute,
            Ee = fe.hasAttribute, be = fe.removeAttribute, ge = fe.setAttribute, ye = r.createElement, He = ye,
            we = me && {attributes: !0, characterData: !0, attributeOldValue: !0}, Ae = me || function (e) {
                De = !1, z.removeEventListener(N, Ae)
            }, Oe = 0, _e = h in r && !/^force-all/.test(n.type), Ne = !0, Se = !1, De = !0, ke = !0, Ie = !0;
        ...
        function xe(e) {
            var t = Te.call(e, "is"), n = e.nodeName.toUpperCase(), r = U.call(R, t ? I + t.toUpperCase() : k + n);
        ...
        function ze(e) {
            var t = e.currentTarget, n = e.attrChange, r = e.attrName, o = e.target, l = e[O] || 2, i = e[_] || 3;
        ...
        function Ge(e, t) {
            var n, r, o = xe(e);
            -1 < o && (f(e, x[o]), o = 0, t !== v || e[v] ? t !== T || e[T] || (e[v] = !1, e[T] = !0, r = "disconnected", o = 1) : (e[T] = !1, e[v] = !0, r = "connected", o = 1, pe && U.call(Le, e) < 0 && Le.push(e)), o && (n = e[t + M] || e[r + M]) && n.call(e))
        }
        ...
        function We(e, t, n) {
            var o = n && n[E] || "", l = t.prototype, i = ce(l), a = t.observedAttributes || G, u = {prototype: i};
            de(i, w, {
                value: function () {
                    if (oe) oe = !1; else if (!this[Y]) {
            ...
            }), l[y] && de(i, g, {value: l[y]}), l[H] && de(i, A, {value: l[H]}), o && (u[E] = o), e = e.toUpperCase(), le[e] = {
                constructor: t,
                create: o ? [o, ue(e)] : [e]
        ...
        if (me && ((d = r.createElement("div")).innerHTML = "<div><div></div></div>", new me(function (e, t) {
            ...
            t.disconnect(), d = null
        }).observe(d, {childList: !0, subtree: !0}), d.innerHTML = ""), _e || (J || Q ? (f = function (e, t) {
            B.call(t, e) || Be(e, t)
        }, p = Be) : p = f = function (e, t) {
            e[L] || (e[L] = o(!0), Be(e, t))
        }, pe ? (De = !1, function () {
            var e = K(fe, C), t = e.value, n = function (e) {
                ...
                var n = Ee.call(this, e), r = n && Te.call(this, e), o = new CustomEvent(N, {bubbles: !0});
                ...
                var t, n = e.currentTarget, r = n[L], o = e.propertyName;
                r.hasOwnProperty(o) && (r = r[o], (t = new CustomEvent(N, {bubbles: !0})).attrName = r.name, t.prevValue = r.value || null, t.newValue = r.value = n[o] || null, null == t.prevValue ? t[O] = t.attrChange = 0 : t.MODIFICATION = t.attrChange = 1, Me.call(n, t))
            };
            ...
            if (this === e.target) {
                ...
                for (r in t) if (!(r in n)) return u(2, this, r, t[r], n[r], _)
            }
            ...
            }, a = t || j, u = q.call(a, E), c = u ? t[E].toUpperCase() : n;
            ...
            var n = Je(t), o = n ? ye.call(r, e, ue(n)) : ye.call(r, e), l = "" + e,
                i = U.call(R, (n ? I : k) + (n || l).toUpperCase()), a = -1 < i;
            return n && (o.setAttribute("is", n = n.toLowerCase()), a && (a = Ve(l.toUpperCase(), n))), Ie = !r.createElement.innerHTMLHelper, a && p(o, x[i]), o
        }), Ke.prototype = {
            constructor: Ke, define: ee ? function (e, t, n) {
                if (n) We(e, t, n); else {
                    var r = e.toUpperCase();
                    le[r] = {constructor: t, create: [r]}, ae.set(t, r), $.define(e, t)
                }
            } : We, get: ee ? function (e) {
                return $.get(e) || Xe(e)
            } : Xe, whenDefined: ee ? function (e) {
                return re.race([$.whenDefined(e), Ye(e)])
            } : Ye
        }, !$ || /^force/.test(n.type)) $e(); else if (!n.noBuiltIn) try {
            !function (e, n, o) {
                if (n[E] = "a", (e.prototype = ce(HTMLAnchorElement.prototype)).constructor = e, t.customElements.define(o, e, n), Te.call(r.createElement("a", {is: o}), "is") !== o || ee && Te.call(new e, "is") !== o) throw n
            }(function e() {
        ...
        return r(a, i), n(a, [{
            key: "connectedCallback", value: function () {
                ...
                if (!this._connected) {
                    ...
                    }), (i = this.api, a = this.url, fetch(i + "/get-claps" + (a ? "?url=" + a : ""), {headers: {"Content-Type": "text/plain"}}).then(function (e) {
                        return e.text()
                    })).then(function (t) {
            ...
            key: "attributeChangedCallback", value: function (e, t, n) {
                this._updateRootColor()
            }
        }, {
            key: "_updateRootColor", value: function () {
                if (this._styleRootElement) {
                    var e = this.getAttribute("color") || "grey", t = this._styleRootElement.style;
                    t.fill = e, t.stroke = e, t.color = e
                }
            }
        }, {
            key: "initialClapCount", get: function () {
