...
<p style="padding-left: 60px;">
  Ca peut aussi arriver dans un bureau mais un peu moins car c&#8217;est un lieu de travail. Quand on est à la maison, on est pas dans un lieu de travail. N choses peuvent nous perturber. Le menuisier qui vient réparer une porte, le chien qui n’arrête pas d&#8217;aboyer durant un call, des enfants qui courent et crient dans tous les sens&#8230; Mais au moins on peut se déplacer, on peut s&#8217;adapter mais parfois ca peut être problématique. 
</p>

&nbsp;

<p style="padding-left: 60px;">
  <span style="font-family: 'Bree Serif'; font-size: 32px;">On ne trouve pas toujours une opportunité</span><span style="font-family: 'Bree Serif'; font-size: 32px;"><img class="aligncenter size-full" src="https://i2.wp.com/media.giphy.com/media/l41lFw057lAJQMwg0/giphy.gif?resize=480%2C270&#038;ssl=1" width="480" height="270" data-recalc-dims="1" /></span>
</p>

<p style="padding-left: 60px;">
  Même si ca se développe de plus en plus, ca reste quand même rare d&#8217;avoir cette possibilité. Et en plus, ca depends grandement du domaine dans lequel vous êtes. Tous les metiers du digital, que ce soit community manager, graphiste , developper, SEO et j&#8217;en passe, c&#8217;est assez facile de trouver un télétravail car tout ce qu&#8217;il vous suffit pour travailler c&#8217;est un ordinateur. Alors que pharmacien par exemple, travailler a distance va être compliqué&#8230; Pour l&#8217;instant le télétravail n&#8217;est pas compatible avec tous les metiers du monde. Mais avec les technologies qui n’arrêtent jamais de se développer, j&#8217;ai espoir que de plus en plus de domaines soient impliqués et que les opportunités se multiplient. 
</p>

&nbsp;

<p style="padding-left: 60px;">
  <span style="font-family: 'Bree Serif'; font-size: 32px;">Contrats moins sécurisants </span>
</p>
...
<p style="padding-left: 60px;">
  Là encore c&#8217;est au cas par cas, mais généralement travail à distance ne rime pas avec CDI. Particulièrement si vous travaillez pour une entreprise qui n&#8217;est pas dans le même pays que vous, vous êtes rémunéré pour votre prestation , point final. Sécurité sociale, assurance maladie, retraite , que de choses dont vous n&#8217;aurez pas droit. Vous pouvez y souscrire en indépendant, mais c&#8217;est à vos charges. Travailler à distance c&#8217;est être plus responsable, il faudra mettre de l&#8217;argent de côté et s&#8217;acquitter de ses taxes tout seul. Et dans certains pays, ces taxes peuvent vous faire crier. Parfois vous aurez besoin de créer une entreprise pour légaliser votre activité dans le cas où le statut d&#8217;indépendant n&#8217;existe pas dans le pays où vous exercez. Et vu que votre contrat vous protege très peu, vous êtes facilement éjectable. Contrairement a un cdi-sé où des enjeux juridiques s&#8217;ajoutent sur la table,  en travailleur indépendant, votre employeur peut vous remercier du jour au lendemain sans problèmes ni suites, c&#8217;est arrivé à certains de mes collègues. Ca rajoute donc une pression supplémentaire quand on sait que c&#8217;est la plus grande peur pour un employé. Mais bon au final ce n&#8217;est pas si compliqué de ne pas se faire virer. Faîtes bien votre taf et ne traitez pas votre patron de mollusque mono-neuronal ou de face de slip, même si je sais que vous en brûlerez d&#8217;envie&#8230; Mais oui. 
</p>
