...
class __TwigTemplate_3c808954f4a46891a831ca712d9797f13461f3120021ce9c874575d983ad1273 extends Twig_Template
{
  ...
  <textarea placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" disabled=\"disabled\" rows=\"{{#if params.lines}}{{ params.lines }}{{else}}1{{/if}}\">{{ params.text }}</textarea>
    ...
    {
        return new Twig_Source("", "form/templates/blocks/textarea.hbs", "/home/senseiba/public_html/wp-content/plugins/mailpoet/views/form/templates/blocks/textarea.hbs");
    }
}
